...
export const TrackApplicationList = [
  ...
  {
    Rejected: [
        { id:1,applicationNo: 'Application1234'},
      {id:2,applicationNo: 'Application1234'},
...
export const IncomeRange=[
  { id:1,label: '1,00,000', value: '3,00,000' },
    {id:2, label: '3,00,000', value: '6,00,000' },
]
...
const Data = [
  {
    ...
    description: 'The Pre-matric Scholarship-SC is provided by the Ministry of Social Justice and the Tribal Welfare Department of Madhya Pradesh. It supports Class 9 and 10 students from low-income families with an annual income below ₹2,50,000. Both genders are eligible.',
  ...
  },
  {
    ...
    description: 'The Pre-matric Scholarship-ST is provided by the Ministry of Tribal Welfare and the Tribal Welfare Department of Madhya Pradesh. It supports Class 9 and 10 students from low-income families with an annual income below ₹2,50,000. Both male and female students are eligible.',
    address: 'Madhya Pradesh',
    imageUrl: 'https://via.placeholder.com/50',
  },
  {
...
export const details=[
  ...
  desc1:"Day scholars receive ₹3500 (₹3850 for disabled students), and hostellers receive ₹7000 (₹7700 for disabled students). The scholarship is available to students domiciled in Madhya Pradesh and is auto-renewed. Students can avail this scholarship even if they are benefiting from another government scholarship, and it is available for one year if the student fails.",
  objective:["Provide financial assistance to ST students in Classes 9 and 10 to encourage continued education.","Support low-income families by reducing the financial burden of schooling.","Promote equal educational opportunities for students with disabilities through higher financial aid.","Reduce dropout rates among ST students by offering incentives to complete secondary education.","Ensure educational support for ST students in both urban and rural areas, particularly in Madhya Pradesh."],
  keyPoints:["Available to ST students in Madhya Pradesh.","Supports day scholars and hostellers.","Annual family income must be below ₹2,50,000.","Application deadline: 31st July, valid till 31st October."],
  ...
  export const myApplicationData=[
    ...
    {id:8,label:"Parent Occupation",value:"Cleanliness worker (Safai Karamchari)"}
]
